...
class JwtFilter (private val jwtUtil: JwtUtil, private val userDetailsService: UserDetailsService ): OncePerRequestFilter() {
    ...
    override fun doFilterInternal(
        ...
        println("Usuario autenticado en JwtFilter: ${SecurityContextHolder.getContext().authentication?.principal}")
        println("Roles del usuario en JwtFilter: ${SecurityContextHolder.getContext().authentication?.authorities}")
            filterChain.doFilter(request, response)
    }
}
